  ...
  - role: Program Committee Members
    people:
      ...
      - name: Eytan Modiano
        ...
        homepage:
      - name: Fan Wu
        affiliation: Jiao Tong University
        homepage:
      - name: Florin Ciucu
        affiliation: University of Warwick, England
        homepage:
      - name: Gaurav Kasbekar
      ...
      - name: Lu Su
        ...
        homepage:
      - name: Luo Yi Fu
        affiliation: Shanghai JiaoTong 
        homepage:
      - name: Magnús Halldórsson
      ...
      - name: Xinbing Wang
        ...
        homepage:
      - name: Xiuzhen Cheng
        affiliation: George Washington Univ, USA
        homepage:
      - name: Yanchao Zhang
        affiliation: Arizona State University, USA
        homepage:
